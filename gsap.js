...
// tweenmax
 var tl = gsap.timeline({defaults:{duration: 1}})
      ...
      tl.from(".anim1",1,{ opacity: 1, scale: "-100%",ease:Expo.easeInOut})
        ...
        .from(".c1",.5,{ opacity: 0, y:"15%",ease:Expo.ease})
        .from(".c2",.5,{ opacity: 0, y:"15%",ease:Expo.ease})
        .from(".c3",.5,{ opacity: 0, y:"15%",ease:Expo.ease})